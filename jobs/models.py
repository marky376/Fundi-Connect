...
class Payment(models.Model):
    ...
    def __str__(self):
        return f"Payment for {self.job.title} ({self.amount} KES) - {self.status}"
...
class JobApplication(models.Model):
    ...
    fundi = models.ForeignKey(User, on_delete=models.CASCADE, related_name='applications_as_fundi')
